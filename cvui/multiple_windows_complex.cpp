...
int main(int argc, const char *argv[])
{
    ...
    cv::Mat img = cv::imread("/home/nvidia/cvui-2.7.0/example/data/lena-face.jpg", cv::IMREAD_COLOR);
    cv::Mat imgRed = cv::imread("/home/nvidia/cvui-2.7.0/example/data/lena-face-red.jpg", cv::IMREAD_COLOR);
    cv::Mat imgGray = cv::imread("/home/nvidia/cvui-2.7.0/example/data/lena-face-gray.jpg", cv::IMREAD_COLOR);
    ...
    while (true) {
        ...
        // window1에 대해서 다음 gui들을 쭉 불러온다.
        // 여러개의 gui를 쓸 예정이니 반드시 cvui::context 사용!!
        ...
        // 해당 row 위치에서부터 불러오는 gui들을 쭉 가로로 배열한다.
        // 맨 마지막 변수는 row가 차지하는 공간 크기(window같은 것 때문에 사용)
        ...
        //padding을 설정하면 각 gui간의 공간을 띄워서 가로로 배열할 수 있다.
        padding = 50;
        ...
        //column도 세로방향인것만 빼고는 beginRow와 완전 똑같다.
        ...
        // 규칙적 padding이 싫다면 space 함수를 통해 떨어뜨리면서 customize 할 수도 있다.
        ...
        // window 1에 대해서 gui update를 다 하고 imshow로 끝낸다.
        ...
        // 여러개의 gui를 쓸 예정이니 반드시 cvui::context 사용!! 나머지는 window1과 완전 동일
